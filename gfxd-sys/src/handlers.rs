...
extern "C" {
    ...
    pub fn gfxd_macro_dflt() -> ::core::ffi::c_int;
}


pub type gfxd_macro_fn_t = ::core::option::Option<unsafe extern "C" fn() -> ::core::ffi::c_int>;
...
extern "C" {
    ...
    pub fn gfxd_arg_dflt(arg_num: ::core::ffi::c_int);
}

pub type gfxd_arg_fn_t = ::core::option::Option<unsafe extern "C" fn(arg_num: ::core::ffi::c_int)>;
